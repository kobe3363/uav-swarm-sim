...
**Last updated:** 2026-08-01 · **Test baseline:** 450 green · **Branch:** main
...
- [ ] **E2:** `--jobs` for the demand path (ENG-09 joblib pattern). **Gates C2** (STUDY-01 re-run: 30 h serial → ~8 h) and can also shorten C1 (~44 h serial → ~16 h) if run before it.
