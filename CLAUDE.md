...
6. **TODO.md synchronization.** Whenever you complete a task or change the test baseline, you MUST update `TODO.md` to reflect the new state before finishing your run.
